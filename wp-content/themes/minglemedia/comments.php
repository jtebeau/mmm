...
if (have_comments()) : ?>
    <h3><?php comments_number(); ?> <?php _e('on', THEME_SLUG); ?> "<?php echo get_the_title(); ?>"</h3>
    <!-- <ul> -->
    <?php wp_list_comments( $list_comments_args ); // Custom callback in functions.php ?>
    <!-- </ul> -->

<?php
    // Page comments
    if ($page_comments && is_page() && !comments_open()) {
...
<?php comment_form( $form_comments_args ); ?>
